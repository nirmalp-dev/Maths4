...
public class Newton_Equal extends AppCompatActivity {
    Button solve,reset;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newton__equal);
        ...
        solve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UnivariateFunction function = Interpolator.interpolate(val_x,val_y);
                double interpolationX=Double.valueOf(x.getText().toString());
               // UnivariateDifferentiableFunction function=dInterpolator.interpolate(x, y);
